...
class Exceptions:
    ...
    @staticmethod
    def token_expired_exception(detail: str = "Access token has expired"):
        """401 Unauthorized exception when access token is expired"""
        Exceptions.raise_exception(
            detail,
            status.HTTP_401_UNAUTHORIZED,
            headers={"WWW-Authenticate": "Bearer"},
    ...
    @staticmethod
    def refresh_token_expired_exception(detail: str = "Refresh token has expired"):
        """401 Unauthorized exception when refresh token is expired"""
        Exceptions.raise_exception(
            detail,
            status.HTTP_401_UNAUTHORIZED,
            headers={"WWW-Authenticate": "Bearer"},
